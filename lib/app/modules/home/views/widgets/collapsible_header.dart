  ...
  Widget _searchBar() => Container(
        ...
        child: GestureDetector(
          ...
          child: AppTextField(
            ...
            contentPadding: REdgeInsets.symmetric(vertical: 10.0, horizontal: 16.0),
            prefixIcon: Assets.iconsSearch.path,
            prefixIconSize: 18,
            prefixIconConstraints: BoxConstraints.tight(const Size(36, 36)), // prefix icon container size
