...
//
//     final searchRepository = searchRepositoryFromJson(jsonString);

import 'dart:convert';

SearchRepositoryResponse searchRepositoryFromJson(String str) => SearchRepositoryResponse.fromJson(json.decode(str));

String searchRepositoryToJson(SearchRepositoryResponse data) => json.encode(data.toJson());
...
class SearchRepositoryResponse {
  ...
  factory SearchRepositoryResponse.fromJson(Map<String, dynamic> json) => SearchRepositoryResponse(
